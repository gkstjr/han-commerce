...
public class QDelivery extends EntityPathBase<Delivery> {
    ...
    private static final long serialVersionUID = 487719374L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QDelivery delivery = new QDelivery("delivery");

    public final com.toy.hancommerce.model.user.QAddress address;
    ...
    public QDelivery(Class<? extends Delivery> type, PathMetadata metadata, PathInits inits) {
        ...
        this.address = inits.isInitialized("address") ? new com.toy.hancommerce.model.user.QAddress(forProperty("address")) : null;
