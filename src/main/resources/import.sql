...
insert into delivery(delivery_id,status , city , street , zipcode) values(1,'READY','경기도','시흥','배곧1');
...
insert into ORDERS(order_id,delivery_id,user_id,total_price,create_date,status) values(1,1,3000,1000,'2024-02-20 20:29:10.779621','ORDER');
insert into ORDERS(order_id,delivery_id,user_id,total_price,create_date,status) values(2,2,3000,2000,'2024-02-20 20:29:10.779621','ORDER');
insert into ORDERS(order_id,delivery_id,user_id,total_price,create_date,status) values(3,3,3000,3000,'2024-02-20 20:29:10.779621','ORDER');
insert into ORDERS(order_id,delivery_id,user_id,total_price,create_date,status) values(4,4,3000,4000,current_timestamp,'ORDER');
insert into ORDERS(order_id,delivery_id,user_id,total_price,create_date,status) values(5,5,3000,5000,current_timestamp,'ORDER');
insert into ORDERS(order_id,delivery_id,user_id,total_price,create_date,status) values(6,6,3000,6000,current_timestamp,'ORDER');
insert into ORDERS(order_id,delivery_id,user_id,total_price,create_date,status) values(7,7,3000,6000,current_timestamp,'ORDER');
insert into ORDERS(order_id,delivery_id,user_id,total_price,create_date,status) values(8,8,3000,7000,current_timestamp,'ORDER');
insert into ORDERS(order_id,delivery_id,user_id,total_price,create_date,status) values(9,9,3000,7000,current_timestamp,'ORDER');